...
def vocab_build(vocab_path, corpus_path, min_count=1):
    """
    create vocabulary, word to id, word2id={[word, [word_id, word_freq]]}
    :param vocab_path:
    :param corpus_path:
    :param min_count:
    :return:
...
if __name__ == '__main__':
    ...
    build_character_embeddings('./data_path/sgns.wiki.char', './data_path/CCKS17/vectors.npy', word2id, 300)
